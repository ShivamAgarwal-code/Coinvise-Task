    ...
    return (
        <div className="footer ptb-100 bg-f9faff">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div className="footer-logo-area">
                            ...
                            <div className="footer-social-icons">
                                <ul>
                                    <li><a href="https://github.com/ShivamAgarwal-code" target="_blank"><i className="fab fa-github"></i></a></li>
            ...
            <div className="container mt-8 mb-[-40px]">
                <p>Built during <a href="#" className='text-blue-500' target='_blank'>Coinvise Task</a> </p>
            </div>
        </div>
    )
}
